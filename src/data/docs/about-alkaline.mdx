---
cover: {src: '../docs/images/alk4.png', alt: "Alkaline Logo"}
title: "About Alkaline"
...
Project specific configuration options are all located in the `configs` directory. This directory contains a number of files that are used to configure the project. The following is a list of the files and their purpose:
